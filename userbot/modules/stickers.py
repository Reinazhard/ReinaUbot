...
async def kang(args):
    ...
    if message and message.media:
        ...
        await args.edit("`Hey koku-jin, i can't kang that one...`")
        return
    ...
    if photo:
        ...
        packnick = f"{user.username} {user.first_name} Nigga's kang pack Vol.{pack}"
        cmd = '/newpack'
        file = io.BytesIO()
        ...
        await args.edit(f"`HaHa Yes!`\n`Your sticker has been kanged by` @{user.username}!\
